...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      adventurerCardEffect(currentPlayer, drawntreasure, cardDrawn, z, state);
      return 0;
    ...
    case great_hall:
      greatHallCardEffect(currentPlayer, handPos, state);
      return 0;
    ...
    case outpost:
      outpostCardEffect(currentPlayer, handPos, state);    
      return 0;
